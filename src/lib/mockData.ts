...
export const mockUsers: User[] = [
  ...
  {
    id: 3,
    email: 'trainer2@ygngym.com',
    name: 'Jane Smith',
    role: 'TRAINER',
    bio: 'Yoga and Pilates instructor dedicated to mindful movement.',
    specialties: ['Yoga', 'Pilates', 'Flexibility'],
    image: 'https://images.unsplash.com/photo-1518611012118-296072bb5602?auto=format&fit=crop&q=80&w=800',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    id: 5,
    email: 'trainer3@ygngym.com',
    name: 'Michael Chen',
    role: 'TRAINER',
    bio: 'Bodybuilding champion focusing on hypertrophy and nutrition.',
    specialties: ['Bodybuilding', 'Nutrition', 'Powerlifting'],
    image: 'https://images.unsplash.com/photo-1583454110551-21f2fa20e59a?auto=format&fit=crop&q=80&w=800',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
  ...
  {
    id: 9,
    email: 'trainer7@ygngym.com',
    name: 'Marcus Thorne',
    role: 'TRAINER',
    bio: 'Strength coach focused on athletic performance and explosive power.',
    specialties: ['Strength & Conditioning', 'Agility', 'Plyometrics'],
    image: 'https://images.unsplash.com/photo-149175235542e-00ca6397eba5?auto=format&fit=crop&q=80&w=800',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
...
export const mockClasses: Class[] = [
  ...
  },
  {
    ...
    capacity: 12,
    image: 'https://images.unsplash.com/photo-1534367507873-d2d7e249ad99?auto=format&fit=crop&q=80&w=800',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
  ...
  },
  {
    ...
    capacity: 25,
    image: 'https://images.unsplash.com/photo-1534258936925-c58be49700fb?auto=format&fit=crop&q=80&w=800',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
